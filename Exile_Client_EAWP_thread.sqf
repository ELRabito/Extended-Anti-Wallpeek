...
_lineIntersectsObjs = flatten [lineIntersectsObjs [eyePos player, AGLToASL positionCameraToWorld [0.1,0,-0.1]],lineIntersectsObjs [eyePos player, AGLToASL positionCameraToWorld [0.1,0,0.1]],lineIntersectsObjs [eyePos player, AGLToASL positionCameraToWorld [0.1,0,0]],lineIntersectsObjs [eyePos player, AGLToASL positionCameraToWorld [-0.1,0,0]],lineIntersectsObjs [eyePos player, AGLToASL positionCameraToWorld [0,-0.1,0]],lineIntersectsObjs [eyePos player, AGLToASL positionCameraToWorld [0,0.1,0.1]]];
